<?php
// /ProjectFolder/admin/adminDashboard/maindash/dashboard.php (PHP prelude)
session_start();
...
$active = 'dashboard';                 // for sidebar highlight
...
/* Example metric: total users with role='user' */
...
/* Absolute URL to profile image (stored like 'uploads/xyz.jpg') */
    ...
    <main class="app">
      ...
      <div class="content">
        ...
        <section class="kpi-grid">
          ...
          <!-- Total Users (click to Users list) -->
          <a class="kpi-card grad-pink" href="/ProjectFolder/admin/adminDashboard/users/users.php">
